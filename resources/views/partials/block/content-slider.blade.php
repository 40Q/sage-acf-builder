    ...
    <div class="container dark">
        <div class="slide-container">
            <div id="section-main-1-carousel-image" class="image inner-controls">
                <div class="slide"><div class="bg-image">
                    <img src="@asset('images/photos/slider-pasta.jpg')" alt="">
                </div></div>
                <div class="slide"><div class="bg-image">
                    <img src="@asset('images/photos/slider-burger.jpg')" alt="">
                </div></div>
                <div class="slide"><div class="bg-image">
                    <img src="@asset('images/photos/slider-dessert.jpg')" alt="">
                </div>
            </div>
            </div>
