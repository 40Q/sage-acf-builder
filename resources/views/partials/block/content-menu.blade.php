    ...
    <div class="menu-sample-carousel carousel inner-controls" data-slick='{
        ...
        <div class="menu-sample">
            <a href="menu-list-navigation.html#Burgers">
                <img src="@asset('images/photos/menu-sample-burgers.jpg')" alt="" class="image">
        ...
        <div class="menu-sample">
            <a href="menu-list-navigation.html#Pizza">
                <img src="@asset('images/photos/menu-sample-pizza.jpg')" alt="" class="image">
        ...
        <div class="menu-sample">
            <a href="menu-list-navigation.html#Sushi">
                <img src="@asset('images/photos/menu-sample-sushi.jpg')" alt="" class="image">
        ...
        <div class="menu-sample">
            <a href="menu-list-navigation.html#Pasta">
                <img src="@asset('images/photos/menu-sample-pasta.jpg')" alt="" class="image">
        ...
        <div class="menu-sample">
            <a href="menu-list-navigation.html#Desserts">
                <img src="@asset('images/photos/menu-sample-dessert.jpg')" alt="" class="image">
        ...
        <div class="menu-sample">
            <a href="menu-list-navigation.html#Drinks">
                <img src="@asset('images/photos/menu-sample-drinks.jpg')" alt="" class="image">
